...
MEASUREMENT_INSTANCE_OUTPUT_DIR = OUTPUTS_DIR_BASE / "05_measurement_instance_extractor"
...
MEASUREMENT_INSTANCE_OUTPUT_FILENAME = "measurement_instance_output.json"
