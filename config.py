...
MEASUREMENT_INSTANCE_OUTPUT_DIR = OUTPUTS_DIR_BASE / "05f_measurement_instance_extractor"
...
STATEMENT_INSTANCE_MODEL = os.getenv("STATEMENT_INSTANCE_EXTRACTOR_MODEL", DEFAULT_MODEL)
