...
async def run_combined_workflow(content: str) -> None:
    ...
    evidence, measurement, modality type, modality instance, and relationship
    ...
    try:
        ...
        with trace(overall_trace_metadata["workflow_name"], metadata=overall_trace_metadata) as overall_span:
            ...
            # === Step 5a: Extract Modality Instances ===
            ...
            # Note: Step 5b currently only uses entity_data. If relationships involving other types (events, statements, etc.)
            ...
            logger.info(f"Step 5a (Modality Instances) Result: {'Success' if modality_instance_data else 'Failed/Skipped'}")
